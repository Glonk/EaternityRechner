...
//
//  public FlexTableRowDropController(FlexTable flexTable, RecipeEdit editRecipeView) {
//    super(flexTable);
//    this.flexTable = flexTable;
//    this.recipeEdit = editRecipeView;
//  }
//
//  @Override
...
//    	
//	    IngredientSpecification switchIng = recipeEdit.recipe.ingredients.get(sourceRow);
//	    
//	    recipeEdit.recipe.ingredients.remove(sourceRow);
//	    recipeEdit.recipe.ingredients.add(targetRow+1, switchIng);
//	    
//	    recipeEdit.displayZutatImMenu( recipeEdit.recipe.ingredients );
//	    // end here
//    }
//    
